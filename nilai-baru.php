...
if($_POST){
	...
	if($eks->insert()){
		...
		// header("location: nilai.php", true, 301);
	}
	
	else{
		echo "<script>alert('Terjadi kesalahan saat penambahan data')</script>";
	}
}
			...
			<div class="flex w-full justify-center">
				<form class="w-full " method="post">
					<div class="flex items-center mb-6">
						...
						<div class="w-4/5">
							<input type="text" id="jm" name="jm" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"  required>
						</div>
					</div>
					<div class="flex items-center mb-6">
						<div class="w-1/5">
						...
						<div class="w-4/5">
							<input id="kt" name="kt"  class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" type="text" required>
						</div>
					</div>
					<div class="flex ">
